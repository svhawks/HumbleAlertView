...
class HumbleAlertView: UIView {
  ...
  override func layoutSubviews() {
    ...
    let titleSize: CGSize? = title.boundingRect(with: constrainedSize, options: .usesLineFragmentOrigin, attributes: [NSAttributedStringKey.font: titleLabel?.font!], context: nil).size
    var messageSize = CGSize.zero
    if message != "" {
      messageSize = message.boundingRect(with: constrainedSize, options: .usesLineFragmentOrigin, attributes: [NSAttributedStringKey.font: messageLabel?.font!], context: nil).size
